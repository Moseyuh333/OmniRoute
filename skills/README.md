...
| `cli-skill-collector`  | Skill Collector         | Discover and install agent skills for your coding CLI tools. Detects installed coding CLIs (Claude Code, Codex, Cursor, Copilot, Cline, OpenCode, Hermes, etc.), searches GitHub for matching agent skills, and installs them. Replaces standalone Skill Collector. |
...
| `cli-skill-collector` | CLI: Skill Collector          | Detect installed coding CLIs on this machine, search GitHub for matching agent skills, and install them. Integrated with OmniRoute's CLI_TOOL_IDS detection.                                   |
